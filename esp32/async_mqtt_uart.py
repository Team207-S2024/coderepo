...
TOPIC_PUB_TEMP = 'EGR314/Team207/TEMP'
TOPIC_PUB_HUM = 'EGR314/Team207/HUM'
TOPIC_PUB_ALERT = 'EGR314/Team207/ALERT'
TOPIC_PUB_STATUS = 'EGR314/Team207/STATUS'
TOPIC_SUB = 'EGR314/Team207/MANUAL'
TOPIC_PUB_MANUAL = 'EGR314/Team207/MANUAL'
...
async def receiver(): 
    ...
    while True:
        ...
        if res==b'!':
            await client.publish(TOPIC_PUB_ALERT, b, qos=1)
            print('published', b)
            b = b''
        elif res==b'+':
            ...
            await client.publish(TOPIC_PUB_STATUS, b, qos=1)
            print('published', b)
            b = b''
        else:
            b+=res
...
def callback(topic, msg, retained, qos):
    ...
    # Check if the received message is from the manual input topic
